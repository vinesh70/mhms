...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- CSS here -->
            ...
            .hero {
    margin-top: 70px;
    background-color: #fff; /* Set an appropriate background color */
    color: #000; /* Set an appropriate text color */
    z-index: 1; /* Set a z-index value to ensure it's in front of other elements */
}
   ...
   <?php include_once('includes/header.php');?>
    ...
    <section class="hero">
      <div class="container">
        ...
        <p>BookMyBai helps you connect with professional and experienced maids
